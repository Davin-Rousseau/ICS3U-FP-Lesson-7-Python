...
def menu_scene():
    ...
    NP = (b'\xff\xff\x00\x22\xce\x22\xff\xff\xff\xff\xff\xff\xff\xff'
    ...
    # add text objects
    text = []
    text1 = stage.Text(width=29, height=12, font=None, palette=NP, buffer=None)
    text1.move(20, 10)
    text1.text("Davin Studios")
    text.append(text1)

    text2 = stage.Text(width=29, height=12, font=None, palette=NP, buffer=None)
    text2.move(40, 110)
